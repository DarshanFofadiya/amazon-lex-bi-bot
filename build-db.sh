...
aws athena start-query-execution \
    --query-string "create external table scenario1 (merchant_customer_id STRING, channel STRING, gl STRING, gl_id INT, category STRING, net_ordered_gms_wk9 double, net_ordered_gms_wk8 double, net_ordered_gms_wk7 double, net_ordered_gms_wk6 double, am STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t' LOCATION '$ATHENA_BUCKET/scenario1';" \
